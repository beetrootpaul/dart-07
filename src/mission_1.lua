...
do
    ...
    function _m_level_bg_init()
        ...
        waves_tile = new_animated_sprite(8, 8, split("24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24,24," .. "32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32," .. "40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40," .. "48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48,48"), 56, true)
    end
    ...
    function _m_level_bg_draw()
        for distance = 0, 16 do
            for lane = 1, 12 do
                waves_tile._draw((lane - 1) * _ts, ceil((distance - 1) * _ts + waves_tile_offset_y))
            end
        end
    end
        ...
        return ({
            ...
            [76] = {
                ...
                new_movement_sequence_factory {
                    ...
                    new_movement_line_factory {angle = .75}
                }
            },
            [77] = {
                40,
            ...
            [78] = {
                ...
                spawn_bullets = function(enemy_movement, player_collision_circle)
                    ...
                    return {
                        enemy_bullet_factory(new_movement_line_factory {target_xy = player_xy}(enemy_xy.minus(0, 7))),
                        enemy_bullet_factory(new_movement_line_factory {target_xy = player_xy}(enemy_xy.minus(0, 1))),
                        enemy_bullet_factory(new_movement_line_factory {target_xy = player_xy}(enemy_xy.plus(0, 5)))
                    }
                end
            },
            [79] = {
            ...
            phases = {
                ...
                },
                {
                    ...
                    function(boss_movement)
                        ...
                        if t_mod_2() > 1.5 then
                            return {
                                enemy_bullet_factory(new_movement_line_factory {
                                    angle = .75,
                                    angled_speed = 1.5
                        ...
                        elseif t_mod_2() < .9 then
                            return {enemy_bullet_factory(new_movement_sinusoidal_factory {
                                speed_y = 1.5,
                                age_divisor = 60,
                                magnitude = 9
                            }(boss_movement.xy.plus(0, 3)))}
                    ...
                    new_movement_loop_factory {
                        ...
                        new_movement_fixed_factory {frames = 30},
                        new_movement_to_target_factory {
                            target_y = _gah - 20,
                            frames = 40,
                            easing_fn = _easing_easeinquad
