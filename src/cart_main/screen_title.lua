...
function new_screen_title(preselected_mission, start_music, start_fade_in, select_controls)
    ...
    function draw_version(base_y)
        _centered_print(_game_version, base_y, _color_14_mauve)
    end
    
    function draw_title(base_y)
        sspr(96, 32, 32, 26, _vs - 96 / 2, base_y)
        sspr(96, 58, 32, 26, _vs - 96 / 2 + 32, base_y)
        sspr(96, 84, 32, 26, _vs - 96 / 2 + 64, base_y)
    end
    
    function draw_high_score(base_y)
    ...
    function draw_button(text, w, base_x, base_y, selected)
        -- button shape
        sspr(selected and 35 or 36, 12, 1, 12, base_x, base_y, w, 12)
        -- button text
    ...
    function screen._draw()
        ...
        if cart_label_mode then
            ...
            sspr(99, 114, 29, 14, _vs - 29 * 2 / 2, 6, 29 * 2, 14 * 2)
            pal(1)
            draw_title(55)
            -- ship
