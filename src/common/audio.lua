...
_sfx_options_change, _sfx_options_confirm, _sfx_powerup_no_effect, _sfx_powerup_picked = 0, 2, 5, 6
--_sfx_options_prev = 1
...
_sfx_player_shoot, _sfx_player_triple_shoot, _sfx_player_shockwave, _sfx_enemy_shoot, _sfx_enemy_multi_shoot, _sfx_damage_player, _sfx_damage_enemy = 10, 11, 12, 13, 14, 16, 17
-- unused yet: 15
-- _sfx_damage_boss = 18
